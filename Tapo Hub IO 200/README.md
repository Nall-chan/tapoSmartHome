...
# tapo Hub IO 200 <!-- omit in toc -->

Einbindung von TP-Link Tapo Smart Hub 200 (H200)
...
- Lokale Netzwerkkommunikation mit dem Tapo Smart Hub H200
...
- TP-Link Tapo Smart Hub H200 (mit LAN-Verbindung)
...
- **H200**: Tapo Smart Hub mit LAN-Verbindung (neueste Generation)

**Hinweis**: Der H200 unterscheidet sich vom H100 durch die direkte LAN-Verbindung, ermöglicht bessere Stabilität und reduziert WLAN-Belastung.

## 5. Verbundene Geräte

Der H200 Hub kann mit folgenden Wireless-Geräten gekoppelt werden:
